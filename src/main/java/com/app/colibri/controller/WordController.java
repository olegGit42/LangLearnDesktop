...
public class WordController {
	...
	public static final DateFormat dateMinuteFormat = new SimpleDateFormat("dd.MM.yyyy HH:mm");
	public static final DateFormat dateDayFormat = new SimpleDateFormat("dd.MM.yyyy");
	...
	public static long getRoundedTimeToMinute(final long time) {
		return getRoundedTime(date, time, dateMinuteFormat);
	}

	public static long getRoundedTimeToDay(final long time) {
		return getRoundedTime(date, time, dateDayFormat);
	}
